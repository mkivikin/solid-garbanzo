...
function loadMarkers(){
  ...
  //$stmt = $mysqli->prepare("call m1();");
  //$stmt->bind_param("i", $experimentID)
  $result = $mysqli->query("call m1()");
...
//"SELECT Markers.MarkerID, Markers.Latitude, Markers.Longitude, AVG(Measurements.AlphaValue), AVG(Measurements.BetaValue),
